...
export async function initMap(container) {
  let result = await $get('/middle/theNumberOfAgriculturalProductsInTheProvinceAndCity')
  ...
  myChart.on("click", function (params) {
    ...
    store.dispatch('productTable/updateQueryCriteria', {
      shipFromAddress: [params.dataIndex]
    })
    // 跳转农产品详情页面
    router.push({
      name: 'product'
