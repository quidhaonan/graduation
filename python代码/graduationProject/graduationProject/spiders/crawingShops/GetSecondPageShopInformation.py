...
class GetSecondPageShopInformation:
    ...
    def getShopInformation(self,response):
        # try:
            ...
            store_grade = response.meta['store_grade']
            ...
            if fans_counts:
                ...
                if fans_counts.endswith('万'):
                    fans_counts=fans_counts.split('万')
                    fans_counts=int(fans_counts)*10000
                # 转为 int
            ...
            if store_ratings:
                ...
                # 转为 int
                store_ratings = float(store_ratings)

            shop_item = ShopItem(name=name, ship_from_address=ship_from_address, vip=vip, main_business=main_business,
                                 introduce=introduce, address=address, shop_url=shop_url, store_grade=store_grade,
                                 cumulative_turnover=cumulative_turnover, fans_counts=fans_counts,
